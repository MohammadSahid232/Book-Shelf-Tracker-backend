  ...
  try {
    ...
    if (process.env.GEMINI_API_KEY && genAI) {
      try {
        ...
        const prompt = `
You are a expert AI Literary Curator and Book Recommendation Assistant.
Based on the following user reading history, ratings, genres, and reviews:
${JSON.stringify(contextData, null, 2)}

Recommend 5 books the user will love.
...
[
  {
    ...
    "author": "Author Name",
    "genre": "Genre Name",
    "reason": "Clear 2-sentence explanation why this book matches their reading taste.",
...
`;
        ...
        console.warn('Gemini API call failed, falling back to algorithmic AI engine:', aiErr.message);
      }
    }
    ...
    const fallbackCatalog = [
      ...
      },
      {
        ...
        genre: 'Finance',
        reason: 'Short, impactful chapters that align with your reading speed preferences.',
        difficulty: 'Easy',
      ...
      },
      {
        ...
        reason: 'Thought-provoking fiction tailored to readers with diverse shelf reviews.',
        difficulty: 'Advanced',
